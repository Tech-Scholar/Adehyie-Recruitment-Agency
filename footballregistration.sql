...
--
-- Table structure for table `footballregistrationform`
--

CREATE TABLE `footballregistrationform` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `footballregistrationform`
--
ALTER TABLE `footballregistrationform`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `footballregistrationform`
--
ALTER TABLE `footballregistrationform`
