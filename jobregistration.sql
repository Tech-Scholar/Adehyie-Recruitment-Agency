...
--
-- Table structure for table `jobregistrationform`
--
...
--
-- Indexes for table `jobregistrationform`
--
ALTER TABLE `jobregistrationform`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `jobregistrationform`
--
ALTER TABLE `jobregistrationform`
